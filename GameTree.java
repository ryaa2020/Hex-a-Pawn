 ...
 * 
 * @author Rachel Yang, Maika Nishiguchi
 */
public class GameTree {
	// create instance variables corresponding to GameTree parent, a list of GameTree children, and useful instance variable to store data passed by the constructors.
